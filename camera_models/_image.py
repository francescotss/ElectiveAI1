...
class ImagePlane:
    ...
    def __init__(self, origin: np.ndarray, dx: np.ndarray, dy: np.ndarray, dz: np.ndarray,
        heigth: int, width: int, mx: float = 1.0, my: float = 1.0, name="ImagePlane") -> None:
        self.origin = origin
        self.dx = dx
        self.dy = dy
        self.heigth = heigth
        ...
        self.reference_frame = ReferenceFrame(origin, dx, dy, dz, name)
